    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-amber-50/30">
      ...
      <div className="bg-gradient-to-br from-amber-900 to-amber-800">
        <div className="max-w-4xl mx-auto px-4 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-8 text-white">Mentions Légales</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-2xl p-8 shadow-md space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-amber-900 mb-4">1. Informations légales</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-amber-900 mb-4">7. Loi applicable</h2>
            <p className="text-gray-600 leading-relaxed">
